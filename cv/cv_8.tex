...
\begin{cv}{\spacedallcaps{Samy Shihata}}\vspace{1.5em} % Your name

\noindent\spacedlowsmallcaps{Personal Informatiol}\vspace{0.5em} % Personal information heading

\NewEntry{}{\textit{Born in Egypt,}}{09 February 1993} % Birthplace and date

\NewEntry{email}{\href{mailto:samy.s.shihata@gmail.com}{samy.s.shihata@gmail.com}} % Email address

\NewEntry{phone}{(H) +2 (03) 5554581\ \ $\cdotp$\ \ (M) +2 01095357548} % Phone number(s)
